...
const translations: Record<Locale, Record<string, string>> = {
  'en-US': {
    ...
    'app.error.notANail': 'Analysis failed. The uploaded image does not appear to contain a nail. Please try again with a clear photo of a nail.',
  ...
  'pt-BR': {
    ...
    'app.error.notANail': 'Análise falhou. A imagem enviada não parece conter uma unha. Por favor, tente novamente com uma foto nítida de uma unha.',
  ...
  'ru-RU': {
    ...
    'app.error.notANail': 'Анализ не удался. Загруженное изображение, по-видимому, не содержит ноготь. Пожалуйста, попробуйте еще раз с четкой фотографией ногтя.',
  ...
  'es-ES': {
    ...
    'app.error.notANail': 'El análisis falló. La imagen subida no parece contener una uña. Por favor, inténtalo de nuevo con una foto clara de una uña.',
